...
;define("pandemic/adapters/application", ["exports", "emberfire/adapters/firebase"], function (_exports, _firebase) {
  "use strict";
...
;define("pandemic/templates/index", ["exports"], function (_exports) {
  ...
  var _default = Ember.HTMLBars.template({
    "id": "WQdZ694W",
    "block": "{\"symbols\":[],\"statements\":[[2,\"INDEX\\n\"],[1,[30,[36,1],[[30,[36,0],null,null]],null]]],\"hasEval\":false,\"upvars\":[\"-outlet\",\"component\"]}",
    "meta": {
...
;define("pandemic/torii-providers/firebase", ["exports", "emberfire/torii-providers/firebase"], function (_exports, _firebase) {
  "use strict";
...
;
          if (!runningTests) {
            require("pandemic/app")["default"].create({"name":"pandemic","version":"0.0.0+573248d4"});
          }
